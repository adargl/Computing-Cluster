...
#     thread1 = threading.Thread(target=multiply_chunk, args=(matrix1, matrix2, 0, chunk_size, result))
#     thread2 = threading.Thread(target=multiply_chunk, args=(matrix1, matrix2, chunk_size, 2 * chunk_size, result))
#     thread3 = threading.Thread(target=multiply_chunk, args=(matrix1, matrix2, 2 * chunk_size, 3 * chunk_size, result))
#     thread4 = threading.Thread(target=multiply_chunk, args=(matrix1, matrix2, 3 * chunk_size, 4 * chunk_size, result))
#     thread5 = threading.Thread(target=multiply_chunk, args=(matrix1, matrix2, 4 * chunk_size, matrix1.shape[0], result))
#
#     # Start the threads
#     thread1.start()
#     thread2.start()
...
# matrix1 = np.random.rand(500, 300)
